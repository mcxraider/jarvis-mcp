...
exports.FINAL_RESPONSE_PROMPT = exports.SIMPLE_CONVERSATION_PROMPT = void 0;
exports.getFunctionCallingSystemPrompt = getFunctionCallingSystemPrompt;
/**
 * Generates system prompt for function calling mode
 *
 * @returns System prompt string for GPT function calling
 */
function getFunctionCallingSystemPrompt() {
 ...
 */
exports.SIMPLE_CONVERSATION_PROMPT = 'You are a helpful and friendly assistant. Provide clear, concise, and helpful responses.';
/**
 * System prompt for generating final responses based on tool execution results
 */
exports.FINAL_RESPONSE_PROMPT = 'You are Jarvis, an intelligent assistant. Based on the tool execution results below, provide a natural, helpful response to the user. Be conversational and explain what was accomplished.';
