...
class PoemGenerator {
     ...
     */
    constructor(targetWordCount = 30) {
...
Please respond with only the poem, no additional text or explanations.`;
    ...
    validateAndCleanPoem(poem) {
        ...
        if (wordCount > this.targetWordCount * 2) {
            ...
            const poemLines = lines.filter((line) => line.trim().length > 0 &&
    ...
    analyzePoem(poem) {
        ...
        const meetsPoemStructure = lineCount >= 2 && lineCount <= 10 && averageWordsPerLine >= 2 && averageWordsPerLine <= 15;
        return {
            wordCount,
            lineCount,
    ...
    detectRhymes(lines) {
        ...
        const lastWords = lines
            ...
            return ((_a = words[words.length - 1]) === null || _a === void 0 ? void 0 : _a.toLowerCase().replace(/[^\w]/g, '')) || '';
        })
...
exports.PoemGenerator = PoemGenerator;
